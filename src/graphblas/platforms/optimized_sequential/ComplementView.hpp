...
namespace GraphBLAS
{
    namespace backend
    {
        ...
        private:
            ...
            friend inline InternalMatrixT const &strip_matrix_complement(
                MatrixComplementView<InternalMatrixT> const &NotM);
        };
...
//****************************************************************************
        ...
        private:
            ...
            // PUT ALL FRIEND DECLARATIONS HERE
            template<typename InternalVectorT>
            friend inline InternalVectorT const &strip_vector_complement(
                VectorComplementView<InternalVectorT> const &Notm);
        };
